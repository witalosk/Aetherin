...
namespace UniversalScreenSpaceReflection
{
    ...
    #pragma warning restore CS0618
        ...
        private class ScreenSpaceReflectionPass : ScriptableRenderPass
        {
            ...
            private GraphicsBuffer m_DepthPyramidMipLevelOffsetsBuffer;
            ...
            public void Dispose()
            {
                ...
                m_DepthPyramidMipLevelOffsetsBuffer = null;
                CoreUtils.Destroy(m_ResolveMat);
            ...
            private void EnsureOffsetBuffer()
            {
                if (m_DepthPyramidMipLevelOffsetsBuffer != null &&
                    m_DepthPyramidMipLevelOffsetsBuffer.IsValid()) return;

                m_DepthPyramidMipLevelOffsetsBuffer =
                    new GraphicsBuffer(GraphicsBuffer.Target.Structured, 15, sizeof(int) * 2);
            }
            ...
            private static void ExecutePass(CommandBuffer cmd, PassData data)
            {
                ...
                using (new ProfilingScope(cmd, new ProfilingSampler("SSR Reprojection")))
                {
                    ...
                    cmd.SetComputeBufferParam(cs, data.copyColorKernel, ShaderIDs._DepthPyramidMipLevelOffsets, data.offsetBufferData);

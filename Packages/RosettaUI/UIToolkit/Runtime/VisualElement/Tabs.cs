        ...
        public void ReplaceTabs(List<(VisualElement header, VisualElement content)> nextTabs)
        {
            ...
            for (var i = 0; i < currentCount; ++i)
            {
                ...
                if (contentNext != null && content != contentNext)
                {
                    ...
                    // Keep the newly inserted element. Retaining the detached previous
                    // content makes the next dynamic rebuild call IndexOf return -1.
                    _tabs[i] = (headerButton, contentNext);
                }
            }
